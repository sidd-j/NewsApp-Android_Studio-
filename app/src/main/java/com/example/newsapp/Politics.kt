...
import com.example.newsapp.databinding.ActivityPoliticsBinding
...
class Politics : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.PoliticsRecylerView.adapter = adapter
        binding.PoliticsRecylerView.layoutManager = LinearLayoutManager(this)
    ...
    private suspend fun fetchNewsArticles(apiKey: String): String {
        val url = URL("https://api.nytimes.com/svc/topstories/v2/politics.json?api-key=$apiKey")
