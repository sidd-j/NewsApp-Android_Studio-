...
import com.example.newsapp.databinding.ActivityWorldNewsBinding
...
class WorldNews : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.WorldRecycleView.adapter = adapter
        binding.WorldRecycleView.layoutManager = LinearLayoutManager(this)
    ...
    private suspend fun fetchNewsArticles(apiKey: String): String {
        val url = URL("https://api.nytimes.com/svc/topstories/v2/world.json?api-key=$apiKey")
