...
class SportsNews : AppCompatActivity() {
    ...
    private lateinit var binding: ActivitySportsNewsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.SportsRecycleView.adapter = adapter
        binding.SportsRecycleView.layoutManager = LinearLayoutManager(this)
    ...
    private suspend fun fetchNewsArticles(apiKey: String): String {
        val url = URL("https://api.nytimes.com/svc/topstories/v2/sports.json?api-key=$apiKey")
